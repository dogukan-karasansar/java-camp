...
public class ICRKPSPublicSoap
{
    ...
    public ICRKPSPublicSoap(){}

    public ICRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ICRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ICRExtendedSoapSerializationEnvelope envelope= new ICRExtendedSoapSerializationEnvelope(ICRExtendedSoapSerializationEnvelope.VER11);
