...
public class ICRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ICRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ICRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ICRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ICRDateTimeConverter dateTimeConverter = new ICRStandardDateTimeConverter();

    public ICRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ICRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ICRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ICRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ICRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ICRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
